...
slug: 2018/08/night-mode-blogger
date: 2020-04-09
draft: false
tags : 
- Customize
...
![](https://1.bp.blogspot.com/-oWadYViOA5A/Xo3mN4oviMI/AAAAAAAANEw/YfKXPC6mWUQwHuEzl3hmNVeAKEYeXE-gACLcBGAsYHQ/s640/How%2Bto%2Badd%2BNightDark%2BMode%2Bin%2BBlogger%2BBlog%2BEasily.jpg)
...
To conclude, in short, we have even reached a point where dark mode is so omnipresent, websites that don't have it seem like they are pointing flashlights to our eyes by comparison. [You can read more on dark mode from here.](https://en.wikipedia.org/wiki/Light-on-dark_color_scheme)  
...
The very first step in creating a dark mode is to add HTML script in your blogger. This section will help in adding an icon in your blog. Go To Theme > Edit HTML and Search for
`</head>` or `&lt;/head&gt;&lt;!--<head/>--&gt;` and paste the following code above it. And yea don't forget to [backup your whole blog](https://www.twistblogg.com/2014/05/how-to-backup-all-blogger-blogs-with-google-takeout.html) before proceeding.  
...
Ok, here's a sample from one of my recent client's website ([Inside The Movie](https://www.insidethemovie.com/)) where I added this dark mode feature. I'll be using Google Chrome for this.  
  

![easily add Dark Mode in Blogger](https://1.bp.blogspot.com/-xtI0keNvMlw/Xo6vYlkPTzI/AAAAAAAANE8/Px35psG38_IApw1_uql0zdOTRueg5VL0wCLcBGAsYHQ/s1600/easily%2Badd%2BDark%2BMode%2Bin%2BBlogger.jpg "easily add Dark Mode in Blogger")
...
[Contact Me](https://www.twistblogg.com/p/contact-us.html)