...
excerpt: Get Wordpress flavored email subscription box for blogger
date: 2018/08/28
slug: 2018/08/wordpress-like-email-subscription-box-for-blogger
image: Premium Email Subscription Widget for Blogger.png
published: true
featured: true
...
Few weeks ago, our team had shared [Stylish Email Subscription Widget](https://twistblogg.blogspot.com/search/label/Subscription%20Widgets) v1,v2 and got lot of responses. Today I personally decided to share another version - **Premium WordPress like email subscription box/widget for blogger**. It looks so premium and eye catching, I bet users can't ignore it.  
...
![Premium Email Subscription Widget for Blogger]("Premium Email Subscription Widget for Blogger.png")
...
I've divided the steps into two parts: Installing Font Awesome Icon and Adding of HTML and CSS Code.Before that, let's [backup the Blog](https://twistblogg.blogspot.com/2014/05/how-to-backup-all-blogger-blogs-with-google-takeout.html).  
  

#### Step 1: Installing Font Awesome Icon

Go to **Blogger Dashboard** → **Template Section** → **Edit HTML**. Search for `<head>` and paste the following code just below `<head>`. Save the Template.  

```html 
<link href='http://netdna.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.css' rel='stylesheet'/>
```

_ Note: Many of you might have already installed font-awesome. If so, ignore step 1!_  
[Also Learn: How to use font awesome icons in Blogger ](https://twistblogg.blogspot.com/2014/01/How-To-Use-FontAwesome-Icons-In-Blogger.html)  
  

#### Step 2: Adding CSS and HTML Code

Go to **Blogger Dashboard** → **Layout Section** → **Add a Gadget** \[Click on Sidebar\] → Press **HTML/JavaScript**. Enclose CSS within `<style>..</style>` tag and place HTML below it.
...
**Recommended:** [Top 5 Free SEO Testing Tools](https://twistblogg.blogspot.com/2014/02/top-5-free-seo-testing-tools.html)  
...
If you love my work and want more [blogger widgets](https://twistblogg.blogspot.com/search/label/Blogger%20Widgets), take 5 seconds and help us grow as a community by sharing on at least one social media. It means a lot. Happy Blogging👷 **\[Tata - Bye Bye in Nepali \]**
